...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        //All stations in zome 1
        String station[]=("Aldagate, Angle, Baker Street,Bank,Barbican,bayswater,blackfriars,bond street,\" +\n" +
        ...
        String b;
        //Using do while loop for another try from user to input
        //correct station
        ...
        String c="";
        //for loop use for stations name in zone1
            ...
            if(str.equalsIgnoreCase(c)){
                ...
                System.out.println("---------------------------------------");
                //Two for loops used for multidimentional array
